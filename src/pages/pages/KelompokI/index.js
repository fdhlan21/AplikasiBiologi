...
function KelompokGlorasiumI({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:252, height:558,   }} source={require('../../../assets/img/glosarium/KelompokI(1).png')} />
...
export default KelompokGlorasiumI;