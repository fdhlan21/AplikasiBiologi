...
function KelompokGlorasiumPSepuluh({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:284, height:511,   }} source={require('../../../assets/img/glosarium/KelompokP(10).png')} />
...
export default KelompokGlorasiumPSepuluh;