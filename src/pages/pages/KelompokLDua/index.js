...
function KelompokGlorasiumLDua({navigation}) {
  return (
    <View style={{ flex: 1, backgroundColor:colors.primary}}>

<ScrollView>
<View style={{padding:10, }}>
    <TouchableOpacity  onPress={()=>navigation.navigate('KelompokGlosariumL')}  style={{width:70, height:36, backgroundColor:colors.tertiary , borderRadius:30, borderWidth:1, borderColor:colors.secondary}}>
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:253, height:610,   }} source={require('../../../assets/img/glosarium/KelompokL(2).png')} />
...
export default KelompokGlorasiumLDua;