...
function KelompokGlorasiumREnam({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:252, height:467,   }} source={require('../../../assets/img/glosarium/KelompokR(6).png')} />
...
export default KelompokGlorasiumREnam;