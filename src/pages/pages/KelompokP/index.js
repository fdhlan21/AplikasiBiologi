...
function KelompokGlorasiumP({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:252, height:611,   }} source={require('../../../assets/img/glosarium/KelompokP(1).png')} />
...
export default KelompokGlorasiumP;