...
function KelompokGlorasiumTTiga({navigation}) {
  return (
    <View style={{ flex: 1, backgroundColor:colors.primary}}>

<ScrollView>
<View style={{padding:10, }}>
    <TouchableOpacity  onPress={()=>navigation.navigate('KelompokGlosariumTDua')}  style={{width:70, height:36, backgroundColor:colors.tertiary , borderRadius:30, borderWidth:1, borderColor:colors.secondary}}>
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:252, height:364,   }} source={require('../../../assets/img/glosarium/KelompokT(3).png')} />
...
export default KelompokGlorasiumTTiga;