...
function KelompokGlorasiumR({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:252, height:299,   }} source={require('../../../assets/img/glosarium/KelompokR(1).png')} />
...
export default KelompokGlorasiumR;