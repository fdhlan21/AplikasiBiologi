...
function KelompokGlorasiumG({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:252, height:315,   }} source={require('../../../assets/img/glosarium/KelompokG(1).png')} />
...
export default KelompokGlorasiumG;