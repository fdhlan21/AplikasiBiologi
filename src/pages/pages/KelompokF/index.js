...
function KelompokGlorasiumF({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:252, height:364,   }} source={require('../../../assets/img/glosarium/KelompokF(1).png')} />
...
export default KelompokGlorasiumF;