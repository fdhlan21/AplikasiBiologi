...
function KelompokGlorasiumBbackup({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:274, height:596,   }} source={require('../../../assets/img/glosarium/KelompokB(1).png')} />
...
export default KelompokGlorasiumBbackup;