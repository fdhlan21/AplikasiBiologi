...
function KelompokGlorasiumM({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:252, height:419,   }} source={require('../../../assets/img/glosarium/KelompokM(1).png')} />
...
<View style={{padding:10, flexDirection:'row', justifyContent:'space-around' }}>
    <TouchableOpacity   style={{width:70, height:36, backgroundColor:colors.white , }}>
        ...
        <TouchableOpacity  onPress={()=>navigation.navigate('KelompokGlosariumMDua')}  style={{width:70, height:36, backgroundColor:colors.tertiary , borderRadius:30, borderWidth:1, borderColor:colors.secondary}}>
        <Text style={{fontFamily:'Alata-Regular', fontSize:12, textAlign:'center', color:colors.white, top:5}}>Next</Text>
    </TouchableOpacity>
</View>
</ScrollView>
...
export default KelompokGlorasiumM;