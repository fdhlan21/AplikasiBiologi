...
function KelompokGlorasiumA({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:252, height:265,   }} source={require('../../../assets/img/glosarium/KelompokA(1).png')} />
...
export default KelompokGlorasiumA;