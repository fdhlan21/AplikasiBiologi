...
function KelompokGlorasiumHDua({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:252, height:385,   }} source={require('../../../assets/img/glosarium/KelompokH(2).png')} />
...
export default KelompokGlorasiumHDua;