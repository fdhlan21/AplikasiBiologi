...
function KelompokGlorasiumNDua({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:253, height:308,   }} source={require('../../../assets/img/glosarium/KelompokN(2).png')} />
...
export default KelompokGlorasiumNDua;