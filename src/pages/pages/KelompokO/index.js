...
function KelompokGlorasiumO({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:252, height:450,   }} source={require('../../../assets/img/glosarium/KelompokO(1).png')} />
...
export default KelompokGlorasiumO;