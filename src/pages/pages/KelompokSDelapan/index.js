...
function KelompokGlorasiumSDelapan({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:277, height:335,   }} source={require('../../../assets/img/glosarium/KelompokS(8).png')} />
...
export default KelompokGlorasiumSDelapan;