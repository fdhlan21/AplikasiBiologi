...
function KelompokGlorasiumE({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:252, height:271,   }} source={require('../../../assets/img/glosarium/KelompokE(1).png')} />
...
export default KelompokGlorasiumE;