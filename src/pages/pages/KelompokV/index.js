...
function KelompokGlorasiumV({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:252, height:617,   }} source={require('../../../assets/img/glosarium/KelompokV(1).png')} />
...
export default KelompokGlorasiumV;