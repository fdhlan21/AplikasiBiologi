...
function KelompokGlorasiumS({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:252, height:618,   }} source={require('../../../assets/img/glosarium/KelompokS(1).png')} />
...
export default KelompokGlorasiumS;