...
function KelompokGlorasiumMDelapan({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:252, height:351,   }} source={require('../../../assets/img/glosarium/KelompokM(8).png')} />
...
export default KelompokGlorasiumMDelapan;