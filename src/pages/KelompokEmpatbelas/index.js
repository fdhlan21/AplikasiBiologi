...
function KelompokEmpatbelas({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:295, height:252,   }} source={require('../../assets/img/plasmodesmata.png')} />

</View>


<View style={{padding:10, alignItems:'center' , top:30}}>
   <Image   style={{width:282, height:326,   }} source={require('../../assets/img/kelompokempatbelas.png')} />
...
export default KelompokEmpatbelas;