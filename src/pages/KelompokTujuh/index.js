...
function KelompokTujuh({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:281, height:214,   }} source={require('../../assets/img/vesikula.png')} />

</View>


<View style={{padding:10, alignItems:'center' , top:30}}>
   <Image   style={{width:288, height:333,   }} source={require('../../assets/img/kelompoktujuh1.png')} />
