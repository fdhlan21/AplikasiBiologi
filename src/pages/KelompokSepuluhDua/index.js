...
function KelompokSepuluhDua({navigation}) {
  return (
...
<View style={{padding:10, }}>
    <TouchableOpacity  onPress={()=>navigation.navigate('KelompokSepuluh')}  style={{width:70, height:36, backgroundColor:colors.tertiary , borderRadius:30, borderWidth:1, borderColor:colors.secondary}}>
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:253, height:279,   }} source={require('../../assets/gif/Ribosom.gif')} />

</View>


<View style={{padding:10, alignItems:'center' , top:30}}>
   <Image   style={{width:282, height:330,   }} source={require('../../assets/img/kelompoksepuluh2.png')} />
...
export default KelompokSepuluhDua;