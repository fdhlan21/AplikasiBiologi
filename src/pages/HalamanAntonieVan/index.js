...
<View style={{padding:10, flexDirection:'row', justifyContent:'space-around',}}>
   <Image   style={{width:142, height:187,}} source={require('../../assets/img/antonie2.png')} />
    <Image   style={{width:142, height:187,}} source={require('../../assets/img/antonie1.png')} />
</View>

<View style={{padding:10}}>
    <Text style={{color:colors.secondary, fontFamily:'Alata-Regular', textAlign:'center', fontSize:15,}}>Mikroskop sederhana buatan</Text>
    <Text style={{color:colors.secondary, fontFamily:'Alata-Regular', textAlign:'center', fontSize:15, bottom:5}}>Anthonie Van Leeuwenhoek</Text>
</View>

<View style={{padding:5}}>
<Text style={{color:colors.secondary, fontFamily:'Alata-Regular', fontSize:15, textAlign:'center'}}>Anthonie Van Leeuwenhoek (1674) ilmuwan berkebangsaan Belanda merupakan orang yang pertama kali mengamati dan menggambarkan makhluk hidup renik dengan mikroskop sederhana sehingga dianggap sebagai mikrobiolog pertama.</Text>
</View>


<View style={{padding:5, top:10}}>
<Text style={{color:colors.secondary, fontFamily:'Alata-Regular', fontSize:15, textAlign:'center'}}>Leeuwenhoek terkenal atas pengembangan mikroskop dengan membuat lensa yang lebih baik sehingga dapat memvisualisasikan sel hidup dan berhasil melihat benda aneh dalam setetes air rendaman jerami.</Text>
</View>
