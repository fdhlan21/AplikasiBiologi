...
function KelompokTransporSelTiga({navigation}) {
  return (
    <View style={{ flex: 1, backgroundColor:colors.primary}}>

<ScrollView>
<View style={{padding:10, }}>
    <TouchableOpacity  onPress={()=>navigation.navigate('HalamanTransporSelDua')}  style={{width:70, height:36, backgroundColor:colors.tertiary , borderRadius:30, borderWidth:1, borderColor:colors.secondary}}>
...
<View style={{padding:10, alignItems:'center' , top:30}}>
   <Image   style={{width:258, height:451,   }} source={require('../../assets/img/kelompoktransportiga.png')} />
...
export default KelompokTransporSelTiga;