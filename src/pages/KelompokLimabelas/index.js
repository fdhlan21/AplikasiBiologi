...
function KelompokLimabelas({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center' , top:30}}>
   <Image   style={{width:257, height:337,   }} source={require('../../assets/img/kelompoklimabelas1.png')} />
...
<View style={{padding:10, flexDirection:'row', justifyContent:'space-around' }}>
    <TouchableOpacity   style={{width:70, height:36, backgroundColor:colors.white , }}>
        ...
        <TouchableOpacity  onPress={()=>navigation.navigate('KelompokLimabelasDua')}  style={{width:70, height:36, backgroundColor:colors.secondary , borderRadius:30, borderWidth:1, borderColor:colors.tertiary}}>
...
export default KelompokLimabelas;