...
function KelompokTigabelasTiga({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center' , top:30}}>
   <Image   style={{width:257, height:199,}} source={require('../../assets/img/kelompoktigabelas3.png')} />
...
export default KelompokTigabelasTiga;