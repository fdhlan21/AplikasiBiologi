...
function KelompokDelapanDua({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:305, height:224,   }} source={require('../../assets/img/Badangolgi2.png')} />

</View>


<View style={{padding:10, alignItems:'center' , top:30}}>
   <Image   style={{width:257, height:388,   }} source={require('../../assets/img/kelompokdelapan2.png')} />
...
export default KelompokDelapanDua;