...
function KelompokDuaTiga({navigation}) {
  return (
...
<View style={{padding:10, }}>
    <TouchableOpacity  onPress={()=>navigation.navigate('KelompokDuaDua')}  style={{width:70, height:36, backgroundColor:colors.tertiary , borderRadius:30, borderWidth:1, borderColor:colors.secondary}}>
...
<View style={{padding:10, alignItems:'center' , top:30}}>
   <Image   style={{width:259, height:244,   }} source={require('../../assets/img/kelompokdua3.png')} />
...
export default KelompokDuaTiga;