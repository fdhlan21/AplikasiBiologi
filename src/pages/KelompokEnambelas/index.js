...
function KelompokEnambelas({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:319, height:197,   }} source={require('../../assets/img/sentrosom.png')} />

</View>


<View style={{padding:10, alignItems:'center' , top:30}}>
   <Image   style={{width:278, height:381,   }} source={require('../../assets/img/kelompokenambelas1.png')} />
...
export default KelompokEnambelas;