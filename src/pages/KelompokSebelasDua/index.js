...
function KelompokSebelasDua({navigation}) {
  return (
...
<View style={{padding:10, }}>
    <TouchableOpacity  onPress={()=>navigation.navigate('KelompokSebelas')}  style={{width:70, height:36, backgroundColor:colors.tertiary , borderRadius:30, borderWidth:1, borderColor:colors.secondary}}>
...
<View style={{padding:10, alignItems:'center' , top:30}}>
   <Image   style={{width:261, height:315,   }} source={require('../../assets/img/KelompokSebelas2.png')} />
...
export default KelompokSebelasDua;