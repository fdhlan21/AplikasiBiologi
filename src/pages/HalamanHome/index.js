...
<View style={{padding:20,  }}>
    <Text style={{color:colors.tertiary, fontSize:20, fontFamily:'Alata-Regular', fontStyle:'italic'}}>Selamat Datang..</Text>
</View>

<View style={{padding:10, }}>
    <Text style={{color:colors.tertiary, fontSize:20, fontFamily:'Alata-Regular', textAlign:'center',  fontWeight:'bold'}}>MEDIA PEMBELAJARAN</Text>
        <Text style={{color:colors.tertiary, fontSize:20, fontFamily:'Alata-Regular', textAlign:'center', fontWeight:'bold' }}>BIOLOGI SEL SMA/MA</Text>        
</View>

<View style={{padding:20}}>
    <Text style={{fontFamily:'Alata-Regular', fontSize:20, }}>Kompetensi Dasar</Text>
</View>

<View style={{padding:10,  alignItems:'center', }}>
<View style={{width:'100%', height:166, backgroundColor:'#cccccc', borderRadius:20, borderWidth:1, borderColor:colors.secondary }} >
<Text style={{fontSize:14, textAlign:'center', color:colors.white, fontFamily:'Alata-Regular', top:40}}>3.1 Menjelaskan komponen kimiawi penyusun sel, struktur, fungsi, dan proses yang berlangsung dalam sel sebagai unit terkecil kehidupan
</Text>
</View>
</View>
...
<View style={{padding:20}}>
    <Text style={{fontFamily:'Alata-Regular', fontSize:20, }}>Tujuan </Text>
        <Text style={{fontFamily:'Alata-Regular', fontSize:20, }}>Pembelajaran</Text>
</View>

<View style={{padding:10,  alignItems:'center', }}>
<View style={{width:'100%', height:327, backgroundColor:colors.tertiary, borderRadius:20, borderWidth:1, borderColor:colors.secondary }} >
<Text style={{fontSize:13, textAlign:'center', color:colors.white, fontFamily:'Alata-Regular', top:80}}>Mendeskripsikan komponen penyusun sel, struktur, fungsi, dan proses yang berlangsung dalam sel sebagai unit terkecil kehidupan
</Text>


<Text style={{fontSize:13, textAlign:'center', color:colors.white, fontFamily:'Alata-Regular', top:80}}>
