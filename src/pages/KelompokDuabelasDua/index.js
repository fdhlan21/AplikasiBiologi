...
function KelompokDuabelasDua({navigation}) {
  return (
...
<View style={{padding:10, }}>
    <TouchableOpacity  onPress={()=>navigation.navigate('KelompokDuabelas')}  style={{width:70, height:36, backgroundColor:colors.tertiary , borderRadius:30, borderWidth:1, borderColor:colors.secondary}}>
...
<View style={{padding:10, alignItems:'center' , top:30}}>
   <Image   style={{width:257, height:342,   }} source={require('../../assets/img/kelompokduableas2.png')} />
...
export default KelompokDuabelasDua;