...
function KelompokEnamDua({navigation}) {
  return (
...
<View style={{padding:10, }}>
    <TouchableOpacity  onPress={()=>navigation.navigate('KelompokEnam')}  style={{width:70, height:36, backgroundColor:colors.tertiary , borderRadius:30, borderWidth:1, borderColor:colors.secondary}}>
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:319, height:241,   }} source={require('../../assets/img/rekelompok6.png')} />

</View>


<View style={{padding:10, alignItems:'center' , top:30}}>
   <Image   style={{width:262, height:177,   }} source={require('../../assets/img/kelompokenam2.png')} />
...
export default KelompokEnamDua;