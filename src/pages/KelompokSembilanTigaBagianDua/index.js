...
function KelompokSembilanTigaBagianDua({navigation}) {
  return (
...
<View style={{padding:10, }}>
    <TouchableOpacity  onPress={()=>navigation.navigate('KelompokSembilanTiga')}  style={{width:70, height:36, backgroundColor:colors.tertiary , borderRadius:30, borderWidth:1, borderColor:colors.secondary}}>
...
<View style={{padding:10, alignItems:'center' , top:30}}>
   <Image   style={{width:266, height:347,   }} source={require('../../assets/img/kelompoksembilan4.png')} />
...
export default KelompokSembilanTigaBagianDua;