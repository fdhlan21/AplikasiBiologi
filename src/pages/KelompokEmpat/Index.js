...
function KelompokEmpat({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:254, height:231,   }} source={require('../../assets/img/Sitoplasma.png')} />

</View>


<View style={{padding:10, alignItems:'center' , top:30}}>
   <Image   style={{width:284, height:347,   }} source={require('../../assets/img/kelompkempat.png')} />
