...
function KelompokSepuluh({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center', top:20 }}>
   <Image   style={{width:320, height:185,   }} source={require('../../assets/img/Ribosom.png')} />

</View>


<View style={{padding:10, alignItems:'center' , top:30}}>
   <Image   style={{width:257, height:265,   }} source={require('../../assets/img/kelompoksepuluh1.png')} />
...
<View style={{padding:10, flexDirection:'row', justifyContent:'space-around' }}>
    <TouchableOpacity   style={{width:70, height:36, backgroundColor:colors.white , }}>
        ...
        <TouchableOpacity  onPress={()=>navigation.navigate('KelompokSepuluhDua')}  style={{width:70, height:36, backgroundColor:colors.secondary , borderRadius:30, borderWidth:1, borderColor:colors.tertiary}}>
        <Text style={{fontFamily:'Alata-Regular', fontSize:12, textAlign:'center', color:colors.white, top:5}}>Next</Text>
    </TouchableOpacity>
</View>
...
export default KelompokSepuluh;