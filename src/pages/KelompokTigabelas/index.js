...
function KelompokTigabelas({navigation}) {
  return (
...
<View style={{padding:10, alignItems:'center' , top:30}}>
   <Image   style={{width:280, height:263,   }} source={require('../../assets/img/kelompoktigabelas1.png')} />
...
<View style={{padding:10, flexDirection:'row', justifyContent:'space-around' }}>
    <TouchableOpacity   style={{width:70, height:36, backgroundColor:colors.white , }}>
        ...
        <TouchableOpacity  onPress={()=>navigation.navigate('KelompokTigabelasDua')}  style={{width:70, height:36, backgroundColor:colors.secondary , borderRadius:30, borderWidth:1, borderColor:colors.tertiary}}>
        <Text style={{fontFamily:'Alata-Regular', fontSize:12, textAlign:'center', color:colors.white, top:5}}>Next</Text>
    </TouchableOpacity>
</View>
...
export default KelompokTigabelas;